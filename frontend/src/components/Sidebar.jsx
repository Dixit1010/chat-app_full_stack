          ...
          >
            ...
            >
              <div className="p-4 border-b border-line flex items-center justify-between">
                <h2 className="font-semibold text-ink">Create New Group</h2>
                <button onClick={() => setIsNewGroupModalOpen(false)} className="text-ink-muted hover:text-ink">
                  <X className="size-5" />
                </button>
              </div>
              ...
              <div className="p-4 space-y-4 overflow-y-auto flex-1">
                ...
                <div>
                  <label className="text-sm font-medium text-ink-muted mb-2 block">Select Members</label>
